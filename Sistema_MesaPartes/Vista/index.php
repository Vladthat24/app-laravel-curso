...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #794c8a !important;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index.php" class="brand-link" style="background-color: #794c8a !important;text-align: center;">
  ...
  <footer class="main-footer">
    ...
    <strong>Derechos Reservados <a href="https://www.facebook.com/softnetpe/" target="_blank">Softnet Solutions Pe</a>.</strong>
  </footer>
